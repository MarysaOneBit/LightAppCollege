...
public class NextDay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!savedGroup.isEmpty()) {
            ...
            new ParseScheduleTask().execute("https://volcollege.ru/rasp/tomorrow/tomorrow.html", savedGroup);
        } else {
        ...
        parseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!group.isEmpty()) {
                    statusTextView.setText("Загрузка расписания...");
                    lessonAdapter.setLessons(new ArrayList<>());
                    new ParseScheduleTask().execute("https://volcollege.ru/rasp/tomorrow/tomorrow.html", group);
                } else {
